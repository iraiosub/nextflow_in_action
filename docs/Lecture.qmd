...
1.  GitHub Codespaces - zero effort
2.  Your laptop - we recommend downloading Docker (ensure Dockerhub is running whenever you want to use it) and then using either the devcontainer (JSON in the repo) OR conda/mamba to install dependencies: `mamba create -n nf -c conda-forge -c bioconda nf-core=3.5.1`
